CREATE TABLE IF NOT EXISTS kpi_realization_v3 (
  kpi_realization_id BIGINT AUTO_INCREMENT PRIMARY KEY,
  ...
  CONSTRAINT fk_kpi_realization_kpi
    FOREIGN KEY (kpi_id) REFERENCES kpi_v3(kpi_id),

  CONSTRAINT fk_kpi_realization_employee
