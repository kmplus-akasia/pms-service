CREATE TABLE IF NOT EXISTS kpi_ownership_v3 (
  kpi_ownership_id BIGINT AUTO_INCREMENT PRIMARY KEY,
  ...
  CONSTRAINT fk_kpi_ownership_kpi
    FOREIGN KEY (kpi_id) REFERENCES kpi_v3(kpi_id),

  CONSTRAINT fk_kpi_ownership_employee
    FOREIGN KEY (employee_number) REFERENCES tb_employee(employee_number),

  CONSTRAINT fk_kpi_ownership_weight_approver
